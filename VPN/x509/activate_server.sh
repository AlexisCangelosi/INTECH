...
iptables -I FORWARD -i tun0 -o eth0 -s 10.8.1.0/24 -d 192.168.0.0/24 -m conntrack --ctstate NEW -j ACCEPT

# Allow traffic initiated from VPN to access 'the world'
iptables -I FORWARD -i tun0 -o eth1 -s 10.8.1.0/24 -m conntrack --ctstate NEW -j ACCEPT
...
iptables -t nat -I POSTROUTING -o eth1 -s 10.8.1.0/24 -j MASQUERADE

# Masquerade traffic from LAN to 'the world'
iptables -t nat -I POSTROUTING -o eth1 -s 192.168.0.0/24 -j MASQUERADE" > $path/vpn_in_progress.sh
